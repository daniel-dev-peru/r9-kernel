 ...
 * 1) Set a break point in QuarkusOpenApiGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class QuarkusOpenApiGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    /*QuarkusOpenApiGenerator quarkusOpenApiGenerator = new QuarkusOpenApiGenerator();
    quarkusOpenApiGenerator.setAppNameBase("TestApp");

    OpenAPI openAPI = new OpenAPIParser()
            .readLocation("../../../modules/openapi-generator/src/test/resources/2_0/petstore.yaml", null, new ParseOptions()).getOpenAPI();
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .addAdditionalProperty("appPathBase","/api/v1/core")
            ; // output directory
