...
public class QuarkusOpenApiGenerator extends AbstractJavaCodegen
        implements BeanValidationFeatures, PerformBeanValidationFeatures, OptionalFeatures {
  private final Logger LOGGER = LoggerFactory.getLogger(QuarkusOpenApiGenerator.class);
  ...
  protected String title = "OpenAPI Quarkus";
  ...
  public QuarkusOpenApiGenerator() {
    super();
  ...
  public void processOpts() {
    ...
    if (additionalProperties.containsKey(JAVA_8)) {
      ...
      LOGGER.warn("java8 option has been deprecated as it's set to true by default");
    }
    ...
    if (additionalProperties.containsKey(APP_NAME_QUARKUS)) {
      ...
      LOGGER.info("APP_NAME_QUARKUS {}",this.getAppNameBase());
    } else {
    ...
    if (additionalProperties.containsKey(APP_PATH_BASE)) {
      ...
      LOGGER.info("APP_PATH_BASE {}",this.getAppPathBase());
    } else {
    ...
    if (additionalProperties.containsKey(REACTIVE)) {
      if (!QUARKUS_LIBRARY.equals(library)) {
        throw new IllegalArgumentException("Currently, reactive option is only supported with quarkus");
      }
    ...
    if (!this.interfaceOnly) {
      if (QUARKUS_LIBRARY.equals(library)) {
        if (additionalProperties.containsKey(APP_NAME_QUARKUS)) {
          ...
          supportingFiles.add(new SupportingFile("openapiQuarkus.mustache",
                  (sourceFolder + File.separator + basePackage).replace(".", File.separator), nameApp+".java"));
        }else{
          supportingFiles.add(new SupportingFile("openapiQuarkus.mustache",
                  (sourceFolder + File.separator + basePackage).replace(".", File.separator), "QuarkusApplication.java"));
        }
    ...
    } else if (this.openapiDocketConfig && !QUARKUS_LIBRARY.equals(library) && !this.reactive && !this.apiFirst) {
      supportingFiles.add(new SupportingFile("openapiDocumentationConfig.mustache",
              (sourceFolder + File.separator + configPackage).replace(".", File.separator), "OpenAPIDocumentationConfig.java"));
    }
  ...
  public void addOperationToGroup(String tag, String resourcePath, Operation operation, CodegenOperation co, Map<String, List<CodegenOperation>> operations) {
    if ((QUARKUS_LIBRARY.equals(library)) && !useTags) {
  ...
  public void preprocessOpenAPI(OpenAPI openAPI) {
    ...
    if (!additionalProperties.containsKey(TITLE)) {
      ...
      LOGGER.info( "Title : {} , paths : {} - {}",   openAPI.getPaths().keySet() );
    ...
    if (openAPI.getPaths() != null) {
      for (Map.Entry<String, PathItem> openAPIGetPathsEntry : openAPI.getPaths().entrySet()) {
        ...
        LOGGER.info("pathnamee : {}", pathname );
  ...
  public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
      ...
      for (final CodegenOperation operation : ops) {
        ...
        if (responses != null) {
          for (final CodegenResponse resp : responses) {
            ...
            LOGGER.info("resp.dataType : {}", resp.dataType );
            doDataTypeAssignment(resp.dataType, new DataTypeAssigner() {
              @Override
              public void setReturnType(final String returnType) {
                LOGGER.info("setReturnType : {}", returnType );
                resp.dataType = returnType;
              }

              @Override
              public void setReturnContainer(final String returnContainer) {
                LOGGER.info("returnContainer : {}", returnContainer );
    ...
    //ServerParamsPostProcessorFactory paramsPostProcessorFactory = new ServerParamsPostProcessorFactory();
    return objs;
  }
  ...
  public void setAppNameBase(String appNameBase) {
    this.appNameBase = appNameBase;
  }

  public void setAppPathBase(String appPathBase) {
    this.appPathBase = appPathBase;
  }

  public String getAppNameBase() {
    return appNameBase;
  }

  public String getAppPathBase() {
    return appPathBase;
  }
  ...
  */
  ...
  public CodegenModel fromModel(String name, Schema model) {
    ...
    //}
    codegenModel.imports = codegenModel.imports.stream().filter(s -> !s.equals("ApiModel")).collect(Collectors.toSet());
